   ...
   metaInfo() {
     ...
     const meta = [
      ...
      },
      {
        ...
        { name: 'twitter:description', content: 'traditional and folk music abc music notation, chords, tabs and midi audio' },
        {
          name: 'description',
          content: 'traditional and folk music abc music notation, chords, tabs and midi audio'
        },
        {
