<template>
  <div class="flex flex-col items-stretch justify-center mx-4">
    <div
    ...
    >
      ...
      <input
        id="search"
        v-model="searchTerm"
        class="input bg-white h-10 px-5 pr-16 text-sm w-full focus:outline-none"
        type="search"
        name="search"
        placeholder="Search"
      />
      ...
      <button
        type="submit"
        class="search-button-icon absolute right-0 top-0"
